        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-7 pb-5">
                ...
                <div class="d-flex align-items-center mb-2 pt-2">
                    <div class="input-group quantity mr-3" style="width: 60px;">
                       <div class="input-group-btn">
                       		<a href="seller_edit_product.jsp?pid=<%= p.getPid()%>">
                            	<button class="btn btn-primary btn-minus">Edit</button>
                            </a>
                        </div>
                    </div>
                    <a href="seller_delete_product.jsp?pid=<%= p.getPid()%>">
